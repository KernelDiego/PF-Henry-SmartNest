...
const AddFavoritesModal: React.FC<{}> = () => {
      ...
      <div className='Modal_Cart_Container'>
        {!user && (
          <div className='Modal_Cart_Info'>
            ...
            <h1>
              It looks like you have not logged in yet, please log in or register to be able to add
              Favorites"
            </h1>
        ...
        {user && !user?.email_verified && (
          <div className='Modal_Cart_Info'>
            ...
            <h1>You need to verify your Email to add Favorites</h1>
            <button onClick={backHandler}>Back</button>
          </div>
        )}
      </div>
